...
use super::{
    ...
    comments::{AttachedReviewComment, CommentOrigin, attach_pending_imported_comments},
...
impl CodeReviewView {
    ...
    fn build_view_state_for_file_diffs(
        ...
        for file in files {
            ...
            // CommentEditor, RichTextEditorView, GlobalBufferModel) that won't
            // be rendered. The content_at_head is stored so the editor can be
            // created lazily when the user expands the file.
